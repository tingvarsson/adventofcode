...
func TestRun(t *testing.T) {
	var tests = []struct {
		...
		{os.Getenv("ROOT") + "/2019/day12/input", 1000, 14606, 543673227860472},
	}

	for _, test := range tests {
		if o1, o2 := run(test.input, test.input2); o1 != test.expected || o2 != test.expected2 {
...
func TestMain(t *testing.T) {
	os.Args[1] = os.Getenv("ROOT") + "/2019/day12/input"
	main()
}
